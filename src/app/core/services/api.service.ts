...
import { IUploadImageResponse } from "../../shared/interfaces/upload-image-responce.interface";
...
export class ApiService {
  ...
  public uploadImage(file: File, productId: number): Observable<IUploadImageResponse> {
